...
const Header = () => {
  ...
  return (
    <>
      <nav class="navbar navbar-dark  navbar-expand-sm dashboard_navbar">
        <div class="container">
          <Link
            to="/"
            style={{
          ...
          <div class="eat_currentAddress_head">
            <Link
              to="/"
              style={{
                textDecoration: "none",
            ...
            <span>Mulund East</span>
          </div>
          <div class="navbar-collapse" id="navbar-list-2">
            <ul class="navbar-nav navMenu">
              ...
              <li class="nav-item li_ShowMobile">
                <svg
                  class="_1GTCc"
                  viewBox="0 0 32 32"
                  height="19"
              ...
              <li class="nav-item">
                <span class="cart_count">
                  <svg
                    ...
                    fill="#686b78"
                  >
                    <path d="M11.9923172,11.2463768 C8.81761115,11.2463768 6.24400341,8.72878961 6.24400341,5.62318841 C6.24400341,2.5175872 8.81761115,0 11.9923172,0 C15.1670232,0 17.740631,2.5175872 17.740631,5.62318841 C17.740631,8.72878961 15.1670232,11.2463768 11.9923172,11.2463768 Z M11.9923172,9.27536232 C14.0542397,9.27536232 15.7257581,7.64022836 15.7257581,5.62318841 C15.7257581,3.60614845 14.0542397,1.97101449 11.9923172,1.97101449 C9.93039471,1.97101449 8.25887628,3.60614845 8.25887628,5.62318841 C8.25887628,7.64022836 9.93039471,9.27536232 11.9923172,9.27536232 Z M24,24 L0,24 L1.21786143,19.7101449 L2.38352552,15.6939891 C2.85911209,14.0398226 4.59284263,12.7536232 6.3530098,12.7536232 L17.6316246,12.7536232 C19.3874139,12.7536232 21.1256928,14.0404157 21.6011089,15.6939891 L22.9903494,20.5259906 C23.0204168,20.63057 23.0450458,20.7352884 23.0641579,20.8398867 L24,24 Z M21.1127477,21.3339312 L21.0851024,21.2122487 C21. " />
                  </svg>
                </span>
                <Link
                  to="/cartitems"
                ...
                >
                  ...
                  {/* <span class="cart_count_value">{cart.length}</span> */}
                  <span class="cart_count_value">{cartItems.length}</span>
                </Link>
              </li>
